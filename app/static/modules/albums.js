...
export function refreshAlbumsRender() {
  _renderAlbumSection({
    ...
    label:         'album',
    emptyMsg:      'No albums yet. Select one or more raw sides above and click <strong>Combine sides into album</strong>.',
  ...
  _renderAlbumSection({
    ...
    tbodyId:       'music-tbody',
    label:         'album',
    emptyMsg:      'No finished albums yet. Tag an album and <strong>Split into tracks</strong> to land it here.',
